...
```{r}
tasas<-read.csv("/Users/isa/Documents/GitHub/inteligencia_artificial/codigos-datascience/RProjects/Ciencia de los datos/1erParcial/TASA_NATALIDAD.csv", header = TRUE)
religiones<-read.csv("/Users/isa/Documents/GitHub/inteligencia_artificial/codigos-datascience/RProjects/Ciencia de los datos/1erParcial/RELIGIONES.csv", header = TRUE)
```
